...
.. note::
  ...
  As a general rule of thumb, **OpenAPI for Python** applies :pep:`PEP 8 <8>` styling,
...
**OpenAPI for Python** is meant to be a "beautiful" and "usable" library. That means
...
**OpenAPI for Python** we rely on several tools:
...
#. Fork the `Git repository <https://github.com/insightindustry/open-api>`_.
...
Check for open `issues <https://github.com/insightindustry/open-api/issues>`_
...
.. seealso::
  ...
  For more information about the **OpenAPI for Python** testing approach please
  see: :doc:`Testing OpenAPI for Python <testing>`
