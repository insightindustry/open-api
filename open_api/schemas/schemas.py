...
class Schemas(OpenAPIDict):
    """A container for a set of :class:`Schema` objects supported by the API. The container
    maps a :class:`Schema` definition to a name.
