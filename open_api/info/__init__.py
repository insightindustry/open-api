...
class Info(OpenAPIObject):
    ...
    def terms_of_service(self, value):
        self._terms_of_service = validators.url(value,
                                                allow_empty = True,
    ...
    def contact(self, value):
        if not value:
            ...
            if checkers.is_type(value, 'Contact'):
                self._contact = value
            else:
                self._contact = Contact.new_from_dict(value)
    ...
    def license(self, value):
        if not value:
            ...
            if checkers.is_type(value, 'License'):
                self._license = value
            else:
                self._license = License.new_from_dict(value)
    ...
    def version(self, value):
        self._version = validators.string(value, allow_empty = True)
